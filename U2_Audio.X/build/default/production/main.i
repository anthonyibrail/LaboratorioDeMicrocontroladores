...
# 52 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8\pic\include\proc\pic18f4550.h"
...
do{
PORTBbits.RB0 = 1;
_delay((unsigned long)((A_LA)*(4000000ul/4000000.0)));
PORTBbits.RB0 = 0;
_delay((unsigned long)((A_LA)*(4000000ul/4000000.0)));
...
do{
PORTBbits.RB0 = 1;
_delay((unsigned long)((B_SI)*(4000000ul/4000000.0)));
PORTBbits.RB0 = 0;
_delay((unsigned long)((B_SI)*(4000000ul/4000000.0)));
...
do{
PORTBbits.RB0 = 1;
_delay((unsigned long)((C_DO)*(4000000ul/4000000.0)));
PORTBbits.RB0 = 0;
_delay((unsigned long)((C_DO)*(4000000ul/4000000.0)));
...
do{
PORTBbits.RB0 = 1;
_delay((unsigned long)((D_RE)*(4000000ul/4000000.0)));
PORTBbits.RB0 = 0;
_delay((unsigned long)((D_RE)*(4000000ul/4000000.0)));
...
do{
PORTBbits.RB0 = 1;
_delay((unsigned long)((E_MI)*(4000000ul/4000000.0)));
PORTBbits.RB0 = 0;
_delay((unsigned long)((E_MI)*(4000000ul/4000000.0)));
...
do{
PORTBbits.RB0 = 1;
_delay((unsigned long)((F_FA)*(4000000ul/4000000.0)));
PORTBbits.RB0 = 0;
_delay((unsigned long)((F_FA)*(4000000ul/4000000.0)));
...
do{
PORTBbits.RB0 = 1;
_delay((unsigned long)((G_SOL)*(4000000ul/4000000.0)));
PORTBbits.RB0 = 0;
_delay((unsigned long)((G_SOL)*(4000000ul/4000000.0)));
